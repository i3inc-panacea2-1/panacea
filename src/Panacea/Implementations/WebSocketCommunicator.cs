...
{
    public class WebSocketCommunicator:IWebSocket
    {
        ...
        {
            Message?.Invoke(this, new MessageEventArgs() { Message = m });
        }
        public void Emit<T>(string verb, T obj, bool addToQueue = true)
        {
            var str =
            JsonSerializer.SerializeToString(new Message(Target.Hospital, verb, addToQueue,
